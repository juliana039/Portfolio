        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: spacing.md, flexWrap: 'wrap' }}>
            {project.projectLink && (
              <a
                ...
                style={{
                  ...
                  gap: spacing.sm,
                  textDecoration: 'none',
                  boxShadow: `0 4px 30px ${colors.primary.blue}35`
                }}
              >
                {project.projectLinkLabel || 'Acessar projeto'}
              </a>
            )}
            ...
            {project.repositoryLink && (
              ...
              >
                <svg style={{ width: '20px', height: '20px' }} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              {project.team.map((member, index) => (
                <div key={index} style={{ textAlign: 'center' }}>
                  ...
                  className="team-member-photo">
                    {!member.photo && member.name.slice(0, 1)}
                  </div>
                  <p style={{
                    fontSize: typography.fontSize.sm,
                    fontWeight: typography.fontWeight.semibold,
