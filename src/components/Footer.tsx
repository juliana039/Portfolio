      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        className="footer-content">
          ...
          <div style={{
            ...
            © 2026 Juliana Magalhães. Todos os direitos reservados.
          </div>

          <div style={{ display: 'flex', gap: spacing.md, fontSize: typography.fontSize.sm }}>
            <a
              href="#"
              style={{
                color: colors.neutral.text.tertiary,
          ...
          <div style={{ display: 'flex', gap: spacing.sm }}>
            <a
              ...
              onMouseOver={(e) => e.currentTarget.style.color = colors.primary.blue}
              onMouseOut={(e) => e.currentTarget.style.color = colors.neutral.text.tertiary}
            >
